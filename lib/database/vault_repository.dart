...
Future<List<TreeItem>> getChildren(
int? parentId,
) async {
final db = await _db;
...
await db.transaction(
  (txn) async {
    await _deleteTreeItemRecursive(
      txn,
      id,
    );
  },
...
Future<List<TableRowData>> getRecords(
int tableItemId,
) async {
final db = await _db;
